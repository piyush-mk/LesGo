...
st.set_page_config(page_title="LesGo | Travel itinerary maker", page_icon="https://github.com/piyush-mk/LesGo/blob/main/asset/favicon.svg", layout="centered", initial_sidebar_state="auto", menu_items=None)
import pandas as pd
